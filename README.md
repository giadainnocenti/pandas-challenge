# pandas-challenge
The data analysis in the folder [PyCitySchool](./PyCitySchools) is made using Pandas package in Python.
The script, written using jupyter notebook can be found [here](./PyCitySchools/PyCitySchools_starter.ipynb).

The goal of this script is to analyze the district-wide standardized test results for a city's school district.
